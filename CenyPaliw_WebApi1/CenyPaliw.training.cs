    ...
    public partial class CenyPaliw
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"typ paliwa", @"typ paliwa", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=2623,MinimumExampleCountPerLeaf=28,LearningRate=0.398725945276053,LabelColumnName=@"Cena",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.203050134408141,FeatureFraction=0.89620453017067,L1Regularization=2E-10,L2Regularization=0.0620340732311171},MaximumBinCountPerFeature=512}));
